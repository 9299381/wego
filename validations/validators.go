...
func (c Custom) IsSatisfied(obj interface{}) bool {
	return true
}

// DefaultMessage return the default error message
func (c Custom) DefaultMessage() string {
	return fmt.Sprintf(MessageTmpls["Custom"], c.Method)
}

// GetKey return the r.Key
func (c Custom) GetKey() string {
	return c.Key
}

// GetLimitValue return nil now
func (c Custom) GetLimitValue() interface{} {
	return nil
}
